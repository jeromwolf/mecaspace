...
python main.py "2025.08.25_monday.csv" -o "2025.08.25_카페영어.mp4" -t cafe -m upbeat
echo "✅ Completed monday content"
echo ""

# TUESDAY - 🛍️ 쇼핑할 때 쓰는 영어 - 가격 흥정하기
echo "📹 Creating tuesday content..."
python main.py "2025.08.26_tuesday.csv" -o "2025.08.26_쇼핑영어.mp4" -t shopping -m calm
echo "✅ Completed tuesday content"
echo ""

# WEDNESDAY - 💼 직장에서 쓰는 영어 - 회의 영어
echo "📹 Creating wednesday content..."
python main.py "2025.08.27_wednesday.csv" -o "2025.08.27_비즈니스영어.mp4" -t business -m calm
echo "✅ Completed wednesday content"
echo ""

# THURSDAY - ✈️ 여행할 때 쓰는 영어 - 호텔에서
echo "📹 Creating thursday content..."
python main.py "2025.08.28_thursday.csv" -o "2025.08.28_여행영어.mp4" -t travel -m inspiring
echo "✅ Completed thursday content"
echo ""

# FRIDAY - 🌟 일상에서 쓰는 영어 - 인사와 안부
echo "📹 Creating friday content..."
python main.py "2025.08.29_friday.csv" -o "2025.08.29_일상영어.mp4" -t daily -m upbeat
