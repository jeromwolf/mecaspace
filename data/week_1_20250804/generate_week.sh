...
python main.py "2025.08.04_monday.csv" -o "2025.08.04_카페영어.mp4" -t cafe -m upbeat
echo "✅ Completed monday content"
echo ""

# TUESDAY - 🛍️ 쇼핑할 때 쓰는 영어 - 옷 사이즈 묻기
echo "📹 Creating tuesday content..."
python main.py "2025.08.05_tuesday.csv" -o "2025.08.05_쇼핑영어.mp4" -t shopping -m calm
echo "✅ Completed tuesday content"
echo ""

# WEDNESDAY - 💼 직장에서 쓰는 영어 - 이메일 시작하기
echo "📹 Creating wednesday content..."
python main.py "2025.08.06_wednesday.csv" -o "2025.08.06_비즈니스영어.mp4" -t business -m calm
echo "✅ Completed wednesday content"
echo ""

# THURSDAY - ✈️ 여행할 때 쓰는 영어 - 공항에서
echo "📹 Creating thursday content..."
python main.py "2025.08.07_thursday.csv" -o "2025.08.07_여행영어.mp4" -t travel -m inspiring
echo "✅ Completed thursday content"
echo ""

# FRIDAY - 🌟 일상에서 쓰는 영어 - 날씨 이야기
echo "📹 Creating friday content..."
python main.py "2025.08.08_friday.csv" -o "2025.08.08_일상영어.mp4" -t daily -m upbeat
